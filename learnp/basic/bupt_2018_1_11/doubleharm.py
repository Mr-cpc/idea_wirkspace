...
# ([a-zA-Z0-9%_.\-]*)
# shijie_url = "http://xyq-ios2.cbg.163.com/app2-cgi-bin//xyq_search.py?orderby=selling_time%20DESC&act=super_query&search_type=overall_lingshi_search&equip_level_min=80&equip_level_max=100&kindid=61&damage=1&added_attr_logic=and&added_attr=2&added_attr_repeat_num=2&serverid=681&page=1&platform=ios&app_version=2.3.2&device_name=My%20iPhone&os_name=iPhone%20OS&os_version=9.3.3&device_id=10272229-E368-4457-95B9-427D8EEDA461"
    ...
    with open('src.info','w',encoding='utf-8') as f:
        ...
        while True:
            ...
            if len(contents) > 0:
                ...
                quanbu_url = re.sub(r'(page=)(\d+)',matchcase(),quanbu_url)
                i += 1
            else:break
